...
export default function Role_list() {
  ...
  { 
    frmCheck.push(
  <Grid item xs={2}>
    <Checkbox defaultChecked key={String("mrole")} onClick={onAssignChange('mrole').bind(this)} name="mrole" inputProps={{ 'aria-label': 'controlled-checkbox' }} />
    </Grid> 
  ) 
  }
  else{
    frmCheck.push(
      <Grid item xs={2}>
        <Checkbox key={String("mrole")} onClick={onAssignChange('mrole').bind(this)} name="mrole" inputProps={{ 'aria-label': 'controlled-checkbox' }} />
        </Grid> 
      ) 
  } 
  ...
  { 
    frmCheck.push(
  <Grid item xs={2}>
    <Checkbox defaultChecked key={String("muser")} onClick={onAssignChange('muser').bind(this)} name="muser" inputProps={{ 'aria-label': 'controlled-checkbox' }} />
    </Grid> 
  ) 
  }
  else{
    frmCheck.push(
      <Grid item xs={2}>
        <Checkbox key={String("muser")} onClick={onAssignChange('muser').bind(this)} name="muser" inputProps={{ 'aria-label': 'controlled-checkbox' }} />
        </Grid> 
      ) 
  }
  ...
  frmCheck.push(
    ...
    if(FormCheckAssign.mbarang===true)
    { 
      frmCheck.push(
    <Grid item xs={2}>
      <Checkbox defaultChecked key={String("mbarang")} onClick={onAssignChange('mbarang').bind(this)} name="mbarang" inputProps={{ 'aria-label': 'controlled-checkbox' }} />
      </Grid> 
    ) 
    }
    else{
      frmCheck.push(
        <Grid item xs={2}>
          <Checkbox key={String("mbarang")} onClick={onAssignChange('mbarang').bind(this)} name="mbarang" inputProps={{ 'aria-label': 'controlled-checkbox' }} />
          </Grid> 
        ) 
    } 
    ...
    if(FormCheckAssign.mcustomer===true)
    { 
      frmCheck.push(
    <Grid item xs={2}>
      <Checkbox defaultChecked key={String("mcustomer")} onClick={onAssignChange('mcustomer').bind(this)} name="mcustomer" inputProps={{ 'aria-label': 'controlled-checkbox' }} />
      </Grid> 
    ) 
    }
    else{
      frmCheck.push(
        <Grid item xs={2}>
          <Checkbox key={String("mcustomer")} onClick={onAssignChange('mcustomer').bind(this)} name="mcustomer" inputProps={{ 'aria-label': 'controlled-checkbox' }} />
          </Grid> 
        ) 
    } 
    ...
    if(FormCheckAssign.torder===true)
    { 
      frmCheck.push(
    <Grid item xs={2}>
      <Checkbox defaultChecked key={String("torder")} onClick={onAssignChange('torder').bind(this)} name="torder" inputProps={{ 'aria-label': 'controlled-checkbox' }} />
      </Grid> 
    ) 
    }
    else{
      frmCheck.push(
        <Grid item xs={2}>
          <Checkbox key={String("torder")} onClick={onAssignChange('torder').bind(this)} name="torder" inputProps={{ 'aria-label': 'controlled-checkbox' }} />
          </Grid> 
        ) 
    }
      ...
      <Row>
        <Col breakPoint={{ xs: 24, md: 12 }}>
          <Card status="Primary" accent="Info">
            <CardHeader><ListIcon style={{marginBottom:-7}} color="primary"/> DATA ROLE <Button 
			style={{marginLeft:30}}
			onClick={() => openNewForm()}
...
<Grid container spacing={3}>
  ...
  <path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z"/>
					...
					else if(column.id==="btn_assign")
					{
						return (
                      <TableCell key={String(column.id)+String("DDDD")} align={column.align}>
					    <Button style={{marginRight:10}} variant="contained" color="inherit" onClick={() => OpenAssignSE(row)}>
						<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-box-arrow-up-right" viewBox="0 0 16 16">
  <path fillRule="evenodd" d="M8.636 3.5a.5.5 0 0 0-.5-.5H1.5A1.5 1.5 0 0 0 0 4.5v10A1.5 1.5 0 0 0 1.5 16h10a1.5 1.5 0 0 0 1.5-1.5V7.864a.5.5 0 0 0-1 0V14.5a.5.5 0 0 1-.5.5h-10a.5.5 0 0 1-.5-.5v-10a.5.5 0 0 1 .5-.5h6.636a.5.5 0 0 0 .5-.5z"/>
  <path fillRule="evenodd" d="M16 .5a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h3.793L6.146 9.146a.5.5 0 1 0 .708.708L15 1.707V5.5a.5.5 0 0 0 1 0v-5z"/>
</svg>&nbsp;
